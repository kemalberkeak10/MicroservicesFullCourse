...
namespace Services.Discount.Services
{
    public class DiscountService : IDiscountService
    {
        ...
        public async Task<Response<NoContent>> Save(Models.Discount discount)
        {
            ...
            return Response<NoContent>.Fail("An error occurred while adding", 500); // 500 = Internal Server Error (Sunucu hatası)
        }
        ...
        public async Task<Response<NoContent>> Update(Models.Discount discount)
        {
            ...
            return Response<NoContent>.Fail("An error occurred while updating. Discount Not Found", 404);
